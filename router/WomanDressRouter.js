...
const WomanDressRouter = express.Router();

WomanDressRouter.post("/addWomanProduct", async (req, res) => {
  try {
...
WomanDressRouter.get("/allWomanProducts", async (req, res) => {
  try {
...
WomanDressRouter.delete("/deleteWomanProduct", async (req, res) => {
  try {
    let { id } = req.body;
...
WomanDressRouter.post("/findWomanProduct", async (req, res) => {
  try {
    let { id } = req.body;
...
WomanDressRouter.put("/updatedWomanProduct", async (req, res) => {
  try {
    let data = req.body;
    if (!data._id) {
...
module.exports = WomanDressRouter;
