...
const ManProductRouter = express.Router()

ManProductRouter.post("/addManProduct", async(req,res) => {
  try {
...
ManProductRouter.get("/allManProducts", async(req,res) => {
  try {
...
ManProductRouter.get('/findManProduct', async(req,res) => {
 try {
   let {id} = req.body
 ...
 ManProductRouter.put("/updatedManProduct", async(req,res) => {
  try {
    let data = req.body
    if(!data._id){
...
module.exports = ManProductRouter